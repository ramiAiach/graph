...
public class TestGraphsPW2 {
	...
	public static void main(String[] args) {
		...
		Graph gin = Graph.fromDotFile("src/test/java/m1graphs2025/resources/isolatedNodes");
		if (gin==null)
		...
		Graph sg = Graph.fromDotFile("src/test/java/m1graphs2025/resources/simpleGraph");
		if (sg==null)
		...
		Graph mg = Graph.fromDotFile("src/test/java/m1graphs2025/resources/multiGraph");
		if (mg==null)
		...
		Graph wsg = Graph.fromDotFile("src/test/java/m1graphs2025/resources/weightedSimpleGraph");
		if (wsg==null)
		...
		Graph wmg = Graph.fromDotFile("src/test/java/m1graphs2025/resources/weightedMultiGraph");
		if (wmg==null)
		...
		// delete
//		Graph guDisc2 = new Graph(1,1,2,2,6,0, 2,3,6,0, 0, 6,0, 6,0, 0, 0, 9,10,0, 0, 0);
...
//		System.exit(0);
		...
		UndirectedGraph uwmg = UndirectedGraph.fromDotFile("src/test/java/m1graphs2025/resources/undirWeightedMultiGraph");
		if (uwmg==null)
